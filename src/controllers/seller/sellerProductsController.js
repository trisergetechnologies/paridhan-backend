...
export const createSellerProduct = async (req, res) => {
  try {
    ...
    const product = await Product.create({
      ...
      blouseIncluded,
      length,
      occasion: occasion != null && String(occasion).trim() ? String(occasion).trim() : undefined,
      pattern: pattern != null && String(pattern).trim() ? String(pattern).trim() : undefined,
      fit: fit != null && String(fit).trim() ? String(fit).trim() : undefined,
      texture: texture != null && String(texture).trim() ? String(texture).trim() : undefined,
      washCare: washCare != null && String(washCare).trim() ? String(washCare).trim() : undefined,
      ironing: ironing != null && String(ironing).trim() ? String(ironing).trim() : undefined,
      storage: storage != null && String(storage).trim() ? String(storage).trim() : undefined,
